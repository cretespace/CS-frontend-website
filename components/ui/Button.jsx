...
const Button = ({ 
  ...
  const variants = {
    primary: 'bg-button-1 text-global-3 hover:bg-green-700 active:bg-blue-800 focus:ring-green-500',
    secondary: 'bg-button-4 text-global-3 hover:bg-green-700 active:bg-green-800 focus:ring-green-500',
