...
const FormComponent = ({array,link, signup,accountType,setAccountType, cta,bottomText}) => {
  ...
  return (
    <form className='p-10 rounded-[18.94px] flex flex-col gap-[28px] [background:radial-gradient(circle,#2FC22B1A_0%,rgba(0,0,0,0.3)_100%)] border-[0.95px] border-[#0C520A80]'>
        {signup &&  
